...
{% include image.html url="../images/RelationalApproach22.jpg" caption="Marginal approach versus relational approach" width="500px" align=thumbnail %}
{% include image.html url="../images/PoliAllFig.jpg" caption="Immobility from political division" width="500px" align=thumbnail %}
