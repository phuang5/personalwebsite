...
{% include image.html url="../images/PoliAllFig.jpg" caption="Immobility from political division" height="300px" align=thumbnail %}
{% include image.html url="../images/RelationalApproach22.jpg" caption="Marginal approach versus relational approach" height="300px" align="left" %}
