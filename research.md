...
{% include image.html url="../images/PoliAllFig.jpg" caption="Immobility from political division" height="400px" align=thumbnail %}
{% include image.html url="../images/RelationalApproach22.jpg" caption="Marginal approach versus relational approach" height="400px" align=thumbnail %}
