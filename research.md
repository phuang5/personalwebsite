...
{% include image.html url="../images/RelationalApproach22.jpg" caption="Marginal approach versus relational approach" width="400px" align=thumbnail %} <br>
{% include image.html url="../images/PoliAllFig.jpg" caption="Immobility from political division" width="400px" align=thumbnail %}
